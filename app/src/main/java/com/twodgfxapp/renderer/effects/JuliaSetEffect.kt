...
/** Julia Set — first touch controls complex parameter C; second touch adjusts zoom. */
class JuliaSetEffect(context: Context) : BaseShaderEffect(context, R.raw.julia_set) {
