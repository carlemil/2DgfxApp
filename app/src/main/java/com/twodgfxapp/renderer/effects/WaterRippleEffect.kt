...
/** Water Ripple supports multi-touch; passes all active pointers to the shader. */
class WaterRippleEffect(context: Context) : BaseShaderEffect(context, R.raw.water_ripple) {

    private var uTouchCountLoc = -1
    private var uTouchesLoc    = -1
    private val touchArray     = FloatArray(10)  // 5 × (x, y)
