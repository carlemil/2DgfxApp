...
/** Mandelbrot fractal — multi-touch for pan/zoom, passed to shader as u_touches array. */
class MandelbrotEffect(context: Context) : BaseShaderEffect(context, R.raw.mandelbrot) {
